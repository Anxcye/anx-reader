...
Future<void> exportNotes(int bookId, ExportType exportType) async {
  ...
  print('Export notes to $savePath, type: $exportType');
  ...
  switch (exportType) {
    ...
    case ExportType.md:
      ...
      if (!await file.exists()) {
        await file.create(recursive: true); // Use recursive: true to create all directories in the path if they do not exist
      }
